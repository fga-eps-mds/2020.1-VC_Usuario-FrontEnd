        ...
        <div class="divLogin">
            ...
            <form @submit.prevent="fazerLogin">
                ...
                <div class="divBotoes">
                    ...
                    <button type="button" onclick="window.location.href= process.env.VUE_APP_API_URL + '/cadastro'">Cadastrar</button>
                </div>
            </form>
        </div>
    </section>  
...
export default {
    ...
    setup() {
        ...
        const voltar = () => {
            if(document.referrer === process.env.VUE_APP_API_URL + "/perfil"){
    ...
    created() {
        ...
        if(token){
            ...
            window.location.href = process.env.VUE_APP_API_URL + "/perfil"
        }
    }
}
